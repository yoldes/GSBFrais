...
public class FenetreTableauEtat extends JFrame {
 FenetreMajEtat f1;
 static String[] title={"Id", "Libelle"};
 static DefaultTableModel m=new DefaultTableModel(null,title);
 DaoGsbFrais d=new DaoGsbFrais();
 static Object[] row1;
 static JTable table;
 JLabel libelle=new JLabel("Saisie des etats");
public FenetreTableauEtat() {
	JFrame f=new JFrame("Mise a jour des Etats");
...
public void initTableau() {
	ArrayList<Etat> listeEtat=d.selectAllEtat();
    for (Etat e1:listeEtat) {
    	Object[] row1= {e1.getId(),e1.getLibelle()};
...
public FenetreMajEtat getF1() {
	return f1;
}

public void setF1(FenetreMajEtat f1) {
	this.f1 = f1;
}
...
public static void setTable(JTable table) {
	FenetreTableauEtat.table = table;
}
